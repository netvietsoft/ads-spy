...
- [x] **Phần 2 affiliate — rút trích nội quy/luật.** XONG 2026-08-13 (…). Thực tế **30%** độ phủ chứ không phải 65% như khảo sát — khảo sát chấm trên text cả trang gồm menu/footer nên là cận trên, đúng như đã ghi. Bảng , job nền  (tab Cài đặt), tóm tắt ghi vào cột Note. Chi tiết: [handoff-2026-08-13-affiliate-noi-quy.md](./handoff-2026-08-13-affiliate-noi-quy.md).
- [ ] **Nội quy có nên ĐÈ Note cũ không?** Hiện chỉ ghi khi Note trống → 22.837/36.241 dòng đã có blurb của mạng (do "Điền hoa hồng") sẽ không nhận nội quy vào Note, vẫn xem được qua chip 📋. Nội quy giá trị hơn blurb — cần anh quyết, đổi một dòng điều kiện trong .
