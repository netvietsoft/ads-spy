...
- [ ] **Phần 2 affiliate — rút trích nội quy/luật.** Khảo sát 2026-08-13 nói KHẢ THI: 65% độ phủ, ~1,9 giờ cho 22.000 chương trình, chưa thấy bị chặn. Nhưng phạm vi lớn hơn "cào + regex": (a) tìm trang phải có ĐỌC SITEMAP — đóng góp 25/65 độ phủ; (b) BẮT BUỘC tách nội dung chính khỏi nav/footer, không thì mọi số liệu luật là nhiễu ("huỷ/hoàn tiền 100%" hiện là do bắt trúng "Refund policy" ở chân trang); (c) taxonomy theo ĐO ĐƯỢC (hoa hồng 92% · thanh toán 73% · địa lý 73% · thuế 58% · cookie 38% · coupon 31%), BỎ cấm-PPC 8% / cấm-trademark 4% / tự-mua 0% vì đó là luật của mạng lớn chứ không phải shop Shopify nhỏ. Chi tiết: [khao-sat-2026-08-13-dieu-khoan-affiliate.md](./khao-sat-2026-08-13-dieu-khoan-affiliate.md).
