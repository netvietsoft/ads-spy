...
- [ ] **S2+S3 — module còn lại:** ads (Google/FB/TikTok), Local DB, Track, Báo cáo — mở cho `user` + cap + hiện tab dần (mỗi module 1 lát cắt).
- [ ] **Hardening:** rate-limit tra cứu live theo khách (chống lạm dụng gọi ShopHunter/proxy); metering atomic nếu đếm export.
