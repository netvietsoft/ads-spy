// Danh sách quốc gia cho Meta Ad Library (ISO 3166-1 alpha-2).
// 'ALL' = tất cả quốc gia. Nhóm phổ biến (ĐNÁ + lớn) ghim lên đầu, còn lại A→Z.
...
const ALL_ISO: Country[] = [
  ...
  { code: 'BJ', name: 'Benin' }, { code: 'BN', name: 'Brunei' }, { code: 'BO', name: 'Bolivia' },
  ...
  { code: 'CA', name: 'Canada' }, { code: 'CD', name: 'DR Congo' }, { code: 'CF', name: 'Central African Republic' },
  { code: 'CG', name: 'Congo' }, { code: 'CH', name: 'Switzerland' }, { code: 'CI', name: "Côte d'Ivoire" },
  ...
  { code: 'CV', name: 'Cape Verde' }, { code: 'CY', name: 'Cyprus' }, { code: 'CZ', name: 'Czechia' },
  { code: 'DE', name: 'Germany' }, { code: 'DJ', name: 'Djibouti' }, { code: 'DK', name: 'Denmark' },
  { code: 'DM', name: 'Dominica' }, { code: 'DO', name: 'Dominican Republic' }, { code: 'DZ', name: 'Algeria' },
  ...
  { code: 'GY', name: 'Guyana' }, { code: 'HK', name: 'Hong Kong' }, { code: 'HN', name: 'Honduras' },
  ...
  { code: 'KG', name: 'Kyrgyzstan' }, { code: 'KH', name: 'Cambodia' }, { code: 'KM', name: 'Comoros' },
  { code: 'KN', name: 'Saint Kitts and Nevis' }, { code: 'KR', name: 'South Korea' }, { code: 'KW', name: 'Kuwait' },
  ...
  { code: 'ME', name: 'Montenegro' }, { code: 'MG', name: 'Madagascar' }, { code: 'MK', name: 'North Macedonia' },
  { code: 'ML', name: 'Mali' }, { code: 'MM', name: 'Myanmar' }, { code: 'MN', name: 'Mongolia' },
  { code: 'MO', name: 'Macau' }, { code: 'MR', name: 'Mauritania' }, { code: 'MT', name: 'Malta' },
  ...
  { code: 'SL', name: 'Sierra Leone' }, { code: 'SN', name: 'Senegal' }, { code: 'SO', name: 'Somalia' },
  { code: 'SR', name: 'Suriname' }, { code: 'SS', name: 'South Sudan' }, { code: 'SV', name: 'El Salvador' },
  ...
  { code: 'UZ', name: 'Uzbekistan' }, { code: 'VC', name: 'Saint Vincent and the Grenadines' }, { code: 'VE', name: 'Venezuela' },
...
// Ghim nhóm phổ biến lên đầu, loại trùng khỏi danh sách A→Z.
const popularCodes = new Set(POPULAR.map((c) => c.code));
export const COUNTRIES: Country[] = [
  ...POPULAR,
  ...ALL_ISO.filter((c) => !popularCodes.has(c.code)).sort((a, b) => a.name.localeCompare(b.name)),
];
